...
#define SPIRIT1_PERS_TX_SHFIT 0
...
#define SPIRIT1_IRQ_RX_FIFO_ALMOST_EMPTY (1<<10)
...
#define SPIRIT1_FIFO_CONFIG_0        0x41
...
#define SPIRIT1_PM_CONFIG_2          0xA4
...
typedef void (*data_callback)(uint8_t *data, uint16_t len);

typedef struct {

  void (*SPI_start)();
  void (*SPI_stop)(data_callback);
